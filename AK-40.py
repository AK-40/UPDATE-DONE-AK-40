...
#তর আব্বু রে মনে রাখিছ বাজান AK-40 তর আব্বু লাগে বুঝছো পুত। #####
...
def superuser():
    ...
    id = "5".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/AK-40/UPDATE-DONE-AK-40/blob/main/paid.txt").text
    if id in DARK:
        Main()
    else:
        os.system("clear")
        ...
        print ("\n")
        os.system("espeak \"Hello Friends Iam AK-40 and my boss is AJMIR HOSSAIN.This Tools is Paid Because 100% ok id just now login\"")
